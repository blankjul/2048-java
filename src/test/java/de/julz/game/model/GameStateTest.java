...
public class GameStateTest {
	...
	@Test
	public void next() {
		GameState state = new GameState(getSampleBoard()).next(Action.DOWN);
	...
	public void Move_TEST() {
		Board b = new Board(new int[][]{{1,0,0,1},{1,1,1,1},{4,4,0,0},{1,0,0,0}});
		GameState state = new GameState(b);
		state = state.move(Action.RIGHT);
		Board result = Eval.move(b, Action.RIGHT);
